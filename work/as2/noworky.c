...
{
	// The unsigned int cause the i variable to overflow since the loop iterator ran one last time 
	// When i == 0 and made the unsigned int overflow into the max unsinged int values and access 
	// the wrong memory. 
	int i;
	for (i = size-1; i >= 0; i--) {
